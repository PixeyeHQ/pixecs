...
const #@templates
  names_stdout: array[6, string] = ["\e[0;32mDebug:\e[39m","\e[0;36mInfo: \e[39m","\e[0;33mWarn: \e[39m","\e[0;31mError:\e[39m","\e[0;35mFatal\e[39m", "\e[0;34mBenchmark:\e[39m"]
...
proc trace*(level: int8 = debug, args: varargs[string, `$`]) {.inline.} =
  if level in log_mask:
    ...
    echo trace_text
  #   #var traceString = ""
  #   for i in 0..traces.high:
  #     var n =  traces[i]
  #     var fn = newString(n.filename.len)
  #     line = intToStr(n.line)
  #     copyMem(addr(fn[i]), n.filename, n.filename.len)
  #     var traceString = fn & "(" & line & ")"
  ...
  #       msg.text.add "\n"
  #     channel.send msg
  #     #traceString.insert(fn & "(" & line & ") ")

  # #  traceString.insert("(" & line & ")")
